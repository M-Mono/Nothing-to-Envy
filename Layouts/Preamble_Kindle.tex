...
BoldFont={方正仿宋_GBK.ttf},
ItalicFont={方正仿宋_GBK.ttf},
BoldItalicFont={方正仿宋_GBK.ttf},
SlantedFont={方正仿宋_GBK.ttf},
BoldSlantedFont={方正仿宋_GBK.ttf},
SmallCapsFont={方正仿宋_GBK.ttf}
]{方正仿宋_GBK.ttf}
\setCJKsansfont[Path=Fonts/]{方正仿宋_GBK.ttf}
\setCJKmonofont[Path=Fonts/]{方正仿宋_GBK.ttf}
\setmainfont[Path=Fonts/]{方正仿宋_GBK.ttf}
\setsansfont[Path=Fonts/]{方正仿宋_GBK.ttf}
\setmonofont[Path=Fonts/]{方正仿宋_GBK.ttf}
% Icon 字体
\newfontfamily{\FA}[Path=Fonts/]{FontAwesome.otf} %License: SIL OFL 1.1
\newfontfamily{\EA}[Path=Fonts/]{EyesAsia-Regular.otf} %License: SIL OFL 1.1
